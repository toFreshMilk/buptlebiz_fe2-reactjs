...
export const STANDARD_COMPONENT_LOADERS = {
  ...
  ContractDetailTopHeader: () => import('@/standard/modules/contract/components/ContractDetailPage/TopHeader'),
  ContractDetailTopProgress: () => import('@/standard/modules/contract/components/ContractDetailPage/TopProgress'),
  ContractDetailLeftPanel: () => import('@/standard/modules/contract/components/ContractDetailPage/LeftPanel'),
  ContractDetailRightActions: () => import('@/standard/modules/contract/components/ContractDetailPage/RightActions'),
  ContractDetailRightSchedule: () => import('@/standard/modules/contract/components/ContractDetailPage/RightSchedule'),
  ContractDetailRightActivity: () => import('@/standard/modules/contract/components/ContractDetailPage/RightActivity'),
