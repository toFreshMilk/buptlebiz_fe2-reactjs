        ...
        <aside className="w-64 bg-gray-900 text-white min-h-[calc(100vh-64px)] hidden lg:block">
            <div className="p-4">
                ...
                <ul className="space-y-2">
                    <li className="px-3 py-2 bg-red-600 rounded-md text-sm font-medium cursor-pointer">
                        Priority Contracts
                    </li>
                    <li className="px-3 py-2 text-gray-300 hover:text-white text-sm cursor-pointer">
                        Hospital Agreements
                    </li>
                    <li className="px-3 py-2 text-gray-300 hover:text-white text-sm cursor-pointer">
                        Supplier Forms
