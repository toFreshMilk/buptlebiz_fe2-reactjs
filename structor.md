buptlebiz_fe2/
│
# 참고: src/ 아래 모든 파일에는 파일 경로가 주석으로 추가되어 있습니다.
# 예: // src/App.tsx 또는 /* src/standard/standard.css */
│
...
│   │   │   └── useTenantModule.ts # 테넌트별 컴포넌트/서비스 동적 로드 Hook
│   │   │
│   │   ├── services/
